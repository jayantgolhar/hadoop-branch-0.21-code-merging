...
public class IsolationRunner {
  ...
  static class FakeUmbilical implements TaskUmbilicalProtocol {
    ...
    //MTP-FIX (dummy code to implement function in interface TaskUmbilicalProtocol)
    /*public TrackerChildResponse pingPSE(TaskAttemptID taskid) throws IOException {
      return new TrackerChildResponse(true, true);
    }*/
