...
public interface MRJobConfig {
  ...
  //FIXME: for PSE
  static final String TASK_ZOOKEEPER_ADDRESS = "pse.task.zookeeper.address"; //zk connection string
  static final String TASK_ZOOKEEPER_TIMEOUT = "pse.task.zookeeper.timeout";
  static final String TASK_MAP_USE_PSE = "pse.map.usePSE";
  static final String TASK_REDUCE_USE_PSE = "pse.reduce.usePSE";
  static final String TASK_PSE_WAITING_TIMEOUT = "pse.task.waiting.timeout";
}
